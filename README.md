...
| 5 | [Elixir cookbook](https://skota.gumroad.com/l/vwuwp/kfkmewu) by Sriram Kota | An ebook with recipes for beginner and intermediate Elixir programmer who need a  quick reference for day to day coding tasks. | 40% OFF (included in url) | 11-18-2023 - 11-30-2023 |
...
| **#** | **Name** | **Description**| **Deal details** (Discount & coupon code)| **Start-End date** |
|:-:|:-:|:-:|:-:|:-:
| 1 | [Hands on DevSecOps, Kubernetes Security, Container Security, API Security, Threat Modeling courses](https://www.practical-devsecops.com/black-friday/) | Practical DevSecOps training for you to learn DevSecOps, Kubernetes Security, Container Security, API Security, and Threat Modeling. | 15% off all courses, save USD 180 or more, discounts applied automatically. | 11-13-2023 - 12-31-2023 |
...
| 7 | [VPS2day](https://www.vps2day.com/pricing?mtm_campaign=black-friday-2023&mtm_source=github&mtm_cid=twf-nikhila-awesome-black-friday-cyber-monday-deals) | VPS2day is a prepaid virtual private root server (VPS) hosting provider. An own server is great for self-hosted open source apps, your personal dedicated VPN, for hosting bots or crawlers or simply your own blog or website. | 3 special VPS types with up to 73% discount (lifetime) | 2023-11-24 - 2023-11-27 |
